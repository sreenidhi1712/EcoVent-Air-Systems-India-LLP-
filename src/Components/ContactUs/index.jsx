...
function Contactus() {
  return (
    <div className="w-[100%] bg-green-600 h-auto py-10 flex  flex-col items-center gap-10">
      ...
      <div className="w-[90%] bg-white rounded-2xl flex flex-col items-center gap-3 py-5 px-3 lap:w-[45%] ml:w-[85%] mm:w-[90%] tab:w-[70%]">
        ...
        <div className="w-[100%] flex flex-col items-start gap-4 ">
          ...
          <input
                ...
                className="border-2 border-gray-400 p-2 w-[100%] rounded-lg "
              />
              <input
                type="text"
          ...
          <input
            ...
            <textarea
              ...
              id="message"
              placeholder="Message"
              className="border-2 border-gray-400 p-2 rounded-lg min-h-6 w-[100%]"
            ></textarea>

            <button className="bg-green-600 text-white py-2 w-[100%] rounded-lg text-xl font-bold lap:w-[50%] lap:self-center">
                SUBMIT
            </button>
        </div>
