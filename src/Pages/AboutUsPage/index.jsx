    ...
    <div className="w-full bg-white mt-20">
      ...
      <section className="bg-gray-100 py-16 px-6 lap:px-20">
        ...
        <div className="grid grid-cols-1 lap:grid-cols-3 gap-8">
          {/* Mission */}
          <div className="bg-white border border-gray-200 shadow-md p-8 text-center rounded-lg">
      ...
      <section className="bg-[#22876A] text-white py-16 px-6 lap:px-20 text-center">
        ...
        <button onClick={()=>navigate("/contactUs")} className="bg-white text-[#22876A] px-8 py-3 text-lg font-semibold rounded-full shadow-lg hover:bg-gray-100 transition">
          Contact Us
        </button>
      </section>
    </div>
